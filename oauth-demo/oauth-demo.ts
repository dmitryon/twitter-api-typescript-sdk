...
import { getXChatConversations, getXChatMessages, sendXChatMessage, getUserPublicKeys, uploadXChatMedia, proxyXChatMedia, updateXChatSettings, getXChatSettings, unlockKeys, registerKeys, changePin, reactToMessage, editMessage, sendTypingIndicator } from "./handlers/xchat-handlers";
...
app.post("/integrations/:id/xchat/change-pin", changePin);
